  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Form.Item
          shouldUpdate={(prev, curr) => prev.recurrenceEnabled !== curr.recurrenceEnabled}
        >
          {() =>
            form.getFieldValue('recurrenceEnabled') && (
              <>
                <Form.Item name="frequency" label="Frequência" rules={[{ required: true }]}>
                  <Select placeholder="Semanal / Quinzenal / Mensal">
                    <Option value="semanal">Semanal</Option>
                    <Option value="quinzenal">Quinzenal</Option>
                    <Option value="mensal">Mensal</Option>
                  </Select>
                </Form.Item>
                <Form.Item name="recurrenceEndDate" label="Data de Fim" rules={[{ required: true }]}>
                  <DatePicker style={{ width: '100%' }} />
                </Form.Item>
              </>
            )
